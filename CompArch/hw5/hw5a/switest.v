...
myROM[0]  = {movi, RXX, Rg0, 4'b0101};
myROM[1]  = {swi,  RXX, Rg0, 4'b1100};
myROM[2]  = {movi, RXX, Rg1, 4'b0000};
myROM[3]  = {swi,  RXX, Rg1, 4'b0001};
myROM[4]  = {addi, RXX, Rg1, 4'b0011};
myROM[5]  = {swi,  RXX, Rg1, 4'b1111};
